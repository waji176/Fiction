...
def get_url(url):
    ...
    urlli = set()
    for num in range(1, 936):
        js = 'window.location.href="https://www.popo.tw/cates/1/subs/5?page={}";'.format(num)
        driver.execute_script(js)
        # time.sleep(5)
        li = driver.find_elements_by_xpath('''//a[@class="bname"]''')
    ...
    for num in range(1, 255):
        js = 'window.location.href="https://www.popo.tw/cates/1/subs/4?page={}";'.format(num)
        driver.execute_script(js)
        # time.sleep(5)
        li = driver.find_elements_by_xpath('''//a[@class="bname"]''')
    ...
    for num in range(1, 1739):
        js = 'window.location.href="https://www.popo.tw/cates/1/subs/1?page={}";'.format(num)
        driver.execute_script(js)
        # time.sleep(5)
        li = driver.find_elements_by_xpath('''//a[@class="bname"]''')
    ...
    for num in range(1, 380):
        js = 'window.location.href="https://www.popo.tw/cates/1/subs/2?page={}";'.format(num)
        driver.execute_script(js)
        # time.sleep(5)
        li = driver.find_elements_by_xpath('''//a[@class="bname"]''')
